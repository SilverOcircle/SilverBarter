...
├── SilverBarterConfig.json          # Main configuration
└── TraderData/
...
3. Start the server - default config will be generated at `$profile:\SilverBarter\SilverBarterConfig.json`
4. Edit the config to set up your traders (positions, filters, stock, etc.)
